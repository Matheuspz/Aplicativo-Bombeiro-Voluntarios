<?php
    ...
    class DecisaoTransporte {
        ...
        public string $decisaoTransporte;
    
        public function __construct(string $decisaoTransporte) {
