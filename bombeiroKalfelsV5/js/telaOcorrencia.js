// Função para alternar a marcação (checked) da div
function toggleCheckbox(checkbox) {
    checkbox.classList.toggle('checked');

    // Você pode adicionar código adicional aqui para realizar ações quando o estado do "checkbox" muda
    // Por exemplo, enviar dados para o servidor, mostrar/ocultar elementos, etc.
}
