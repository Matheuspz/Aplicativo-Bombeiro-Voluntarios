            ...
            <div class="corposGrid">
                <div class="corpos">
                    <div class="corpo">
                        ...
                        <div class="parteCorpo cabeca" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo ombroEsquerdo" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo ombroDireito" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo peito" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo bracoEsquerdo" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo bracoDireito" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo barriga" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo antebracoEsquerdo" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo antebracoDireito" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo quadril" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo pernaEsquerda" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo pernaDireita" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo maoEsquerda" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo maoDireita" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo tibiaEsquerda" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo tibiaDireita" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo peEsquerdo" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo peDireito" onclick="toggleCheckbox(this)"></div>
                    </div>
                    <h2>Frente</h2>
                </div>
                <div class="corpos">
                <div class="corpo">
                        <img src="../img/corpo.png" alt="" srcset="">
                        <div role="checkbox" class="parteCorpo cabeca" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo ombroEsquerdo" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo ombroDireito" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo peito" onclick="toggleCheckbox(this)"></div>
                        <div class="parteCorpo bracoEsquerdo" onclick="toggleCheckbox(this)"></div>
