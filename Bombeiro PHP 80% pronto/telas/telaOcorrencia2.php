<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        $psiquiatrico = isset($_POST['psiquiatrico']) ? $_POST['psiquiatrico'] : null;
        ...
        $opcaoProblemaOutro = isset($_POST['opcaoProblemaOutro']) ? $_POST['opcaoProblemaOutro'] : null;
            ...
            <section class="sectionProblemas">
                ...
                <div class="problemasGrid">
                    <div class="opcaoProblema">
                        <input type="checkbox" name="psiquiatrico" id="" value="1">
                    ...
                    <div class="opcaoProblema">
                        ...
                        <div class="hidden hiddenObstétrico">
                            <div class="obstetricoCells">
                                <input type="radio" name="opcaoObstetrico" id="" value="4">
                                <label for="">Parto Emergencial</label>
                            </div>
                            <div class="obstetricoCells">
                                <input type="radio" name="opcaoObstetrico" id="" value="5">
                                <label for="">Gestante</label>
                            </div>
                            <div class="obstetricoCells">
                                <input type="radio" name="opcaoObstetrico" id="" value="6">
                    ...
                    <div class="opcaoProblema">
                        <input type="checkbox" name="respiratorio" id="" value="2">
                    ...
                    <div class="opcaoProblema">
                        <input type="checkbox" name="diabetes" id="" value="3">
                        <label for="">Diabetes</label>
                    </div>
                    <div class="opcaoProblema">
                        <input type="checkbox" name="opcaoProblemaOutro" id="">
