        ...
        <section class="upperSection">
            <div class="upperGrid">
                ...
                <div class="cadastroPaciente">
                    ...
                    <input type="text" name="sobrenomePaciente">
                </div>

                <div class="cadastroPaciente">
                    <label for="">Idade:</label>
                    <input type="number" name="idadePaciente">
                </div>
                ...
                <div class="cadastroPaciente">
                    ...
                    <input type="text" name="CpfRgPaciente">
                </div>
        ...
        <section class="middleSection">
            <aside>
                ...
                <div class="localOcorrencia">
                    ...
                    <input type="text" name="localocorrencia" id="">
                </div>
            </aside>
            <aside class="rightAside">
                ...
                <div class="lowerGrid">
                    ...
                    <div class="tipoOcorrencia">
                        <input type="radio" name="tipoOcorrencia" id="">
