...
--
-- Host: 127.0.0.1
-- Tempo de geração: 23-Nov-2023 às 16:27
...
CREATE TABLE `ocorrencia` (
  ...
  `problemas_encontrados_suspeitos_outros` varchar(256) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'respiratório'),
(3, 'diabetes'),
(4, 'obs_parto_emergencial'),
(5, 'obs_gestante'),
(6, 'obs_hemor.escessiva');
...
CREATE TABLE `sinais_sintomas` (
  ...
  `cianose_extremidades` int(11) NOT NULL,
  ...
  `pupila_anisocoria` int(11) NOT NULL,
  `pupila_isocoria` int(11) NOT NULL,
  `pupila_midriase_reagente` int(11) NOT NULL,
  `pupila_midriase_nao_reagente` int(11) NOT NULL,
  `pupila_miose` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(1, 'email@gmail.com', '0b3821b4bf2c0cd0a286fe4a09c852b9', '123qwe', 2);
...
--
ALTER TABLE `avaliacao_glasgow_menor`
  MODIFY `id_glasgow_menor` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `sinais_sintomas`
  MODIFY `id_sinais_sintomas` int(11) NOT NULL AUTO_INCREMENT;
