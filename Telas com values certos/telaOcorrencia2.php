            ...
            <section class="sectionProblemas">
                ...
                <div class="problemasGrid">
                    <div class="opcaoProblema">
                        <input type="checkbox" name="problemaSuspeito" id="" value="1">
                    ...
                    <div class="opcaoProblema">
                        <input type="checkbox" name="problemaSuspeito" id="" value="2">
                    ...
                    <div class="opcaoProblema">
                        <input type="checkbox" name="problemaSuspeito" id="" value="3">
