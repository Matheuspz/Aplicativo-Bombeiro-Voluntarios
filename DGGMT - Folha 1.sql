...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16/11/2023 às 16:23
...
--
-- Estrutura para tabela `ocorrencia_avaliação_glasgowmenor`
--
...
--
-- Índices de tabela `ocorrencia_avaliação_glasgowmenor`
--
...
--
-- Restrições para tabelas `ocorrencia_avaliação_glasgowmenor`
--
ALTER TABLE `ocorrencia_avaliação_glasgowmenor`
